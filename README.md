...
Just me, an Arduino Uno R3, and whatever components I could get my hands on. This repo is where I dump everything I build — animations, sensors, displays, whatever comes next. Some of it is clean, some of it is held together by hope and a bad wiring job. Either way, it works.

No particular theme here. If I build something and it runs, it ends up in a folder in this repo.
...
*Wiring diagrams are included in each folder. Read them. Seriously.*
